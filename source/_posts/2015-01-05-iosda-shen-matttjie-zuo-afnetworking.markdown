...
layout: post
title: "AFNetworking"
date: 2015-01-05 12:56:20 +0800
comments: true
categories: 源代码
keywords: AFNetworking, 源代码, mattt, 网络通信, iOS网络通信类库, AFURLSessionManager, Wiki, iOS, iOS开发, cocoapods, 个人博客, 刚刚在线
description: "iOS大神mattt杰作网络通信之AFNetworking"
...
AFNetworking是一个轻量级的iOS网络通信类库，继ASI类库不在更新之后开发者们有一套不错选择；
 ...
 <a href="https://github.com/AFNetworking/AFNetworking"target="_blank"title="源代码">源代码</a> 
